...
## Outcoin Security Team

| Name        | Email                                  | GPG fingerprint                                   |
|-------------|----------------------------------------|---------------------------------------------------|
| Outcoin Dev | dev [AT] outcoin [DOT] org             | TBD                                               |

## Original Electrum Security Team (acknowledgment)
...
These public keys can also be found in the Outcoin git repository,
