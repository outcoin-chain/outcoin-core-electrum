...
if sys.version_info[:3] < _min_python_version_tuple:
    sys.exit("Error: Outcoin requires Python version >= %s..." % MIN_PYTHON_VERSION)
...
setup(
    name="Outcoin",
    version=version.OUTCOIN_VERSION,
    ...
    description="Lightweight Outcoin Wallet",
    author="Outcoin Development Team",
    author_email="dev@outcoin.org",
    license="MIT Licence",
    url="https://outcoin.org",
    long_description="""Lightweight Outcoin Wallet""",
)
